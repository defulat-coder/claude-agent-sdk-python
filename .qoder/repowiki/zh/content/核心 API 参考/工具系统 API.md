...
## 更新摘要
**变更内容**
- 更新了MCP工具系统的架构说明，反映最新的内部实现细节
- 新增了SDK MCP服务器的详细工作原理和性能优势
- 完善了工具权限回调机制的技术细节
- 增强了外部MCP服务器集成的最佳实践指导
- 更新了端到端测试的验证方法和断言逻辑
...
## 简介
本文档详细介绍 Claude Agent SDK 的工具系统 API，重点覆盖：
...
- 与 CLI 的集成
  ...
  - [查询层路由 SDK MCP 请求:394-538](file://src/claude_agent_sdk/_internal/query.py#L394-L538)
  - [CLI 传输层传递 mcp_servers:240-265](file://src/claude_agent_sdk/_internal/transport/subprocess_cli.py#L240-L265)